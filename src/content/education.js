            ...
            "roles": [
                {
                    ...
                    "description": ["My experiences in high school shaped who I am today. Amazing mentors introduced me to programming, and got me hooked on solving problems, making games, and creating artwork with code. Martial arts taught me discipline and perseverance, as I earned my black belt in Tae Kown Do after training for over 10 years. Volleyball showed me how powerful it is to play and win as a team. Joining the a cappella team proved to myself that I could step outside my comfort zone and succeed. STEM outreach turned me into a leader and teacher."],
                }
            ],
            "skills": [
                { "text": "National Honor Society", "primary": "true" },
                { "text": "AP Scholar", "primary": "true" },
                { "text": "Tae Kwon Do (Black Belt)" },
                { "text": "Varsity Volleyball (MVP)" },
                { "text": "A Cappella" },
                { "text": "STEM Outreach" },
            ]
        }
